...
export default function Produtos() {
    ...
    const editar = (e) => {
        setModoEdicao(true);
        let produtoEditado = produtos.find(p => p.id == e.target.id);
        produtoEditado.dataCadastro = produtoEditado.dataCadastro.substring(0, 10);
    ...
    const excluir = (e) => {
        let produtoExcluido = produtos.find(p => p.id == e.target.id);

        // eslint-disable-next-line no-restricted-globals
        if (confirm("Deseja realmente excluir o produto " + produtoExcluido.nome)) {
            produtoService.excluir(produtoExcluido.id)
                .then(() => {
                    excluirProdutoNaLista(produtoExcluido);
                })
        }
    }
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-2">
                                    <label for="quantidadeEstoque" className="form-label">Qtd Estoque</label>
                                    <input
